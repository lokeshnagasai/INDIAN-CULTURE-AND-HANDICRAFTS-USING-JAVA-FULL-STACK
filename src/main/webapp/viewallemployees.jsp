...
<h1 align=center>Members registered to LAS website</h1>

<br>

<ul>
  <li><a href="adminhome">Home</a></li>
  <li><a class="active"  href="viewallemps">View All Users</a></li>
...
<td> <c:out value="${emp.Face}"></c:out>   </td>
<td> <c:out value="${emp.Population}"></c:out>   </td>
